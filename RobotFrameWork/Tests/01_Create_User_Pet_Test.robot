...
Resource                ../Resources/Ghrekin/01_Create_User_Pet_Keywords.robot
...
User can access website and add a new pet owner
    ...
    AND can verify a new owner 1 is saved       ${FIRST_NAME_OWNER_1}       ${LAST_NAME_OWNER_1}        # revised by Feng
